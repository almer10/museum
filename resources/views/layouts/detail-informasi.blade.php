...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('source/css/detail-informasi.css') }}">
...
<body>
    ...
    <div>
        ...
        @yield('detail-informasi') {{-- jadi ini nanti isinya halaman-halaman lain, biar pake boostrap nya 1 aja --}}
