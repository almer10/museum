...
@section('edit-data')
    <div class="containter p-5">
        <div class="card mx-auto">
            ...
            <form method="post" action="{{ route('pusaka.update', ['bendaPusaka' => $bendaPusaka->id]) }}"
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="kategori" name="kategori">
                        @foreach ($category as $cat)
                            <option value="{{ $cat }}" {{ $bendaPusaka->kategori == $cat ? 'selected' : '' }}>
                                {{ ucwords($cat) }}</option>
                        @endforeach
                    </select>
                    @error('kategori')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="keadaanDahulu" name="kondisi_dahulu"
                        value="{{ $bendaPusaka->kondisi_dahulu }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="keadaanSekarang" name="kondisi_sekarang"
                        value="{{ $bendaPusaka->kondisi_sekarang }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="asalPerolehan" name="asal_perolehan"
                        value="{{ $bendaPusaka->asal_perolehan }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="tanggalPerolehan" name="tanggal_perolehan"
                        value="{{ $bendaPusaka->tanggal_perolehan->format('Y-m-d') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tempatPeyimpanan" name="tempat_penyimpanan"
                        value="{{ $bendaPusaka->tempat_penyimpanan }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="keterangan_benda" name="keterangan_benda"
                        value="{{ $bendaPusaka->keterangan_benda }}">
